...
import com.vocsy.fakecall.ui.RecentFragment;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.MyClass> {
    ...
    public HistoryAdapter(Context context, List<HistoryModels> historyModels) {
        ...
        myInterface= (OnClickRecent) context;
    }
    ...
    public void onBindViewHolder(@NonNull MyClass holder, int position) {
        ...
        if (MainScreenActivity.historyOrNot==true){
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (historyModels.get(position).getAv() == 0) {
                    context.startActivity(new Intent(context, VoiceCallScreenActivity.class));
                } else {
                    context.startActivity(new Intent(context, VideoCallScreenActivity.class));
                }
            }
        });
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.delete:
                        ...
                        RecentFragment.historyTextMethod();
