...
import com.vocsy.fakecall.onclick.OnClickRecent;
import com.vocsy.fakecall.base.MyPermission;
...
public class MainScreenActivity extends MyPermission implements OnClickRecent, OnClickPermission {
...
//        editor.apply();
        ...
        switch (value) {
            case 0:
                ...
                historyOrNot = true;
                getSupportFragmentManager().beginTransaction().replace(R.id.container, new RecentFragment(), "historyFragment").commit();
                break;
            case 1:
                String[] permissions;
                ...
                startPermission(MainScreenActivity.this, permissions, 251);
                break;
            case 2:
                titleText.setText("Favorite");
                favouriteOrNot = true;
                historyOrNot = false;
                getSupportFragmentManager().beginTransaction().replace(R.id.container, new ContactScreenFragment(), "contactsBookFragment").commit();
                break;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.favourites:
                        ...
                        return true;
                    case R.id.setting:
                        startActivity(new Intent(MainScreenActivity.this, SettingScreenActivity.class));
                        break;
                }
                return false;
            }
    ...
    public void onBackPressed() {
        ...
        ContactScreenFragment contactsBookFragment = (ContactScreenFragment) getSupportFragmentManager().findFragmentByTag("contactsBookFragment");
