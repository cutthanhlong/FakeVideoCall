...
public class RecordDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                switch (STATE_BUTTON) {
                    ...
                    case "RECORD":
                        ...
                        STATE_BUTTON = "STOP";
                        _timerView.setText("Click to save");
        ...
        alertDialog = new AlertDialog.Builder(getActivity(), R.style.Theme_AppCompat_DayNight_Dialog_Alert);
    ...
    private File file() {
        ...
        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath(), timeStamp + ".mp3");
